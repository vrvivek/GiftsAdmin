...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2020 at 07:37 AM
...
(15, '2020_12_10_132508_create_admins_table', 1),
(16, '2020_12_10_132630_create_feedbacks_table', 1),
(17, '2020_12_10_132635_create_states_table', 1),
(18, '2020_12_10_132702_create_categorys_table', 1),
(19, '2020_12_10_140122_create_secret_ques_table', 1),
(20, '2020_12_10_140511_create_photos_table', 1),
(21, '2020_12_10_143002_create_sub-categorys_table', 1),
(22, '2020_12_10_143102_create_products_table', 1),
(23, '2020_12_10_152928_create_citys_table', 1),
(24, '2020_12_10_153234_create_users_table', 1),
(25, '2020_12_10_153534_create_carts_table', 1),
(26, '2020_12_10_153557_create_orders_table', 1);
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_city_id_foreign` FOREIGN KEY (`City_Id`) REFERENCES `citys` (`City_Id`) ON DELETE CASCADE,
  ADD CONSTRAINT `users_secret_id_foreign` FOREIGN KEY (`Secret_Id`) REFERENCES `secret_ques` (`Secret_Id`) ON DELETE CASCADE,
  ADD CONSTRAINT `users_state_id_foreign` FOREIGN KEY (`State_Id`) REFERENCES `states` (`State_Id`) ON DELETE CASCADE;
COMMIT;
